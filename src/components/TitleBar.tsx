  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 pl-3" data-tauri-drag-region>
        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full bg-accent text-[9px] font-black text-white">
          AI
        </span>
        <span className="text-[11px] font-medium tracking-wide text-zinc-700">
          AI Editor
        </span>
      ...
      <div className="flex h-full items-stretch">
        {WINDOW_BUTTONS.map((b) => (
          <button
            ...
            aria-label={b.label}
            onClick={b.onClick}
            className={`flex w-11 items-center justify-center text-[10px] text-zinc-500 transition-colors ${
              b.key === "close"
                ? "hover:bg-red-600 hover:text-zinc-800"
